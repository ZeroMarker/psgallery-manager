...
### Changed
- Improve CI: add validation step before release
- Add environment protection for PSGallery publish
- Add pre-publish module validation and post-publish verification
- Add manual publish workflow (`workflow_dispatch`)
